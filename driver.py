...
from src.raritan.ra_pdu_handler import RaPduHandler
...
class RaritanPx2IpduGen2Driver(ResourceDriverInterface):
    ...
    def get_inventory(self, context):
        ...
        '''
        resource = RaritanPx2IpduGen2.create_from_context(context)
        ...
        '''
        handler = RaPxPduAutoloader(context)
    ...
    # <editor-fold desc="Power Commands">
    def PowerCycle(self, context, ports, delay):
        try:
            float(delay)
        except ValueError:
