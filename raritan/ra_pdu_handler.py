from src.raritan.autoload.ra_px_pdu_autoloader import RaPxPduAutoloader
...
class RaPduHandler:
    ...
    def get_inventory(self):
        autoloader = RaPxPduAutoloader(self.context)
    ...
    def power_cycle(self, port_list, delay):
        ...
        for raw_port in port_list:
            ...
            self.snmp_handler.set(ObjectIdentity('PDU2-MIB', 'pmPowerMgmtOutletsTablePowerControl', port.port_number, port.pdu_number, port.outlet_number),
                                  Gauge32(3))
